<script>
import ParadoxUpgradeButton from "./ParadoxUpgradeButton";
import PrimaryButton from "@/components/PrimaryButton";

export default {
  name: "ParadoxUpgradesTab",
  components: {
    PrimaryButton,
    ParadoxUpgradeButton
  },
  data() {
    return {
      isUseless: false,
    ...
    grid() {
      return [
        [
          ...
          ParadoxUpgrade.ADCheaper_1,
          ParadoxUpgrade.ADScaleLess_1,
        ],
        [
        ...
        [
          ...
          ParadoxUpgrade.DimSacAllADs_1,
          ParadoxUpgrade.GalaxyBoost_1,
        ],
        [
          ParadoxUpgrade.Tickspeed_1,
          ParadoxUpgrade.TickspeedCheaper_1,
          ParadoxUpgrade.TickspeedFree_1
        ],
        [
          ParadoxUpgrade.Ach_1,
          ParadoxUpgrade.AllADsAreUnlocked_1,
...
<template>
  <div class="l-infinity-upgrades-tab">
    ...
    >
      ...
      >
        Respec Charged Paradox Upgrades on next Reality
      </PrimaryButton>
    </div>
    <div v-if="chargeUnlocked">
      You have charged {{ formatInt(chargesUsed) }}/{{ formatInt(totalCharges) }} Paradox Upgrades.
      Charged Infinity Upgrades have their effect altered.
      <br>
      Hold shift to show Charged Paradox Upgrades. You can freely respec your choices on Reality.
    </div>
    <div v-if="isUseless">
      You cannot Charge Paradox Upgrades while Doomed.
    </div>
    <br>
