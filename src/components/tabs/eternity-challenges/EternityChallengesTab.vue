...
<template>
  <div class="l-challenges-tab">
    ...
    <div v-if="unlockedCount !== 13">
      You have seen {{ formatInt(unlockedCount) }} out of {{ formatInt(13) }} Eternity Challenges.
    </div>
    <div v-else>
      You have seen all {{ formatInt(13) }} Eternity Challenges.
    </div>
    <ChallengeGrid
      v-slot="{ challenge }"
