...
export const paradoxUpgrades = {
  ADbuy10_1: {
    id: "ADbuy10_1",
    cost: 1,
    description: () => `Antimatter Dimensions have a buy 10 multiplier of ${format(5)}`,
    effect: () => 5,
  ...
  BaseAD_1: {
    id: "BaseAD_1",
    cost: 3,
    description: () => `Antimatter Dimensions are multiplied by ${format(50)}`,
    effect: () => 50,
    formatEffect: value => formatX(value, 2, 2),
    charged: {
      description: () => `Antimatter Dimensions gain a buy 10 multiplier based on Teresa level`,
  ...
  BaseAD_2: {
    ...
    description: () => `Antimatter Dimensions are multiplied by ${format(1000)}`,
    effect: () => 1000,
    formatEffect: value => formatX(value, 2, 2),
    charged: {
      description: () => `Antimatter Dimensions gain a buy 10 multiplier based on Teresa level`,
  ...
  Dimboost_1: {
    id: "Dimboost_1",
    cost: 5,
    description: () => `Dimensions Boosts have a base multiplier of ${format(8)}`,
    effect: () => 8,
  ...
  Tickspeed_1: {
    id: "Tickspeed_1",
    cost: 5,
    description: () => `Tickspeed have a base multiplier of ${format(1.25,2,2)}`,
    effect: () => 1.25,
    formatEffect: value => formatX(value, 2, 2),
    charged: {
  ...
  Ach_1: {
    id: "Ach_1",
    cost: 6,
    description: () => `Achievement multiplier have a base multiplier of ${format(1.3,2,1)} and ${format(3)} for completed rows`,
    effect: () => 1.3,
    formatEffect: value => formatX(value, 2, 2),
  },
  AllADsAreUnlocked_1: {
