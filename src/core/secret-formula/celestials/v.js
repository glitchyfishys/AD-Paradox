...
export const v = {
  ...
  runUnlocks: [
    ...
    },
    {
      ...
      condition: () => V.isRunning && EternityChallenge(8).isRunning,
    ...
    },
    {
      ...
      condition: () => V.isRunning && EternityChallenge(13).isRunning && !PlayerProgress.dilationUnlocked(),
    ...
    },
    {
      ...
      condition: () => V.isRunning && player.dilation.active && EternityChallenge(6).isRunning,
