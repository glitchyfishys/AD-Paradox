export const tabs = [
  ...
  },
  {
    ...
    subtabs: [
      ...
      {
        key: "context",
        name: "Nerfs and Information",
        symbol: "<i class='fas fa-file-text'></i>",
  ...
  },
  {
    ...
    hideAt: 2.3,
    id: 12,
    condition: () => PlayerProgress.realityUnlocked() || PlayerProgress.absurdityUnlocked(), // i think it borked
    hidable: true,
    subtabs: [
      {
        key: "absurdityUpgrades",
        name: "Absurdity Upgrades",
        symbol: "⨈",
        component: "AbsurdityUpgradesTab",
        id: 0,
        hidable: true,
      },
      {
